  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-5 sm:px-6 py-4 border-b border-white/5">
        <h2 className="text-base font-serif font-semibold text-[#f0f4f1]">Latest Stories</h2>
        <Link
          to={createPageUrl("Journal")}
          className="flex items-center gap-1 text-xs text-emerald-400 hover:text-emerald-300 transition-colors font-sans"
        >
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <Clock className="w-3 h-3 text-emerald-800/60" />
              ...
              <ArrowRight className="w-4 h-4 text-emerald-800/40 group-hover:text-emerald-400 transition-colors flex-shrink-0" />
            </Link>
          );
        })}
      </div>
